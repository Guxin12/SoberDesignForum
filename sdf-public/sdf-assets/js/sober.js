...
(() => {
    ...
    var ut = (s, t) => {
        ...
        g = s => {
            ...
            for (let r in s) {
                ...
                r.startsWith("$") && (i.key = r.slice(1), i.sync = !1), Array.isArray(a) && (i.types = a, a = i.types[0]), t[i.key] = a, e[i.key] = {
                    sync: i.sync,
                    def: a,
                    to: l => {
                        switch (typeof a) {
                            case "string":
                                let n = String(l);
                                return i.types.length > 0 ? i.types.includes(n) ? n : i.types[0] : n;
                            case "number":
                                let d = Number(l);
                                return isNaN(d) ? a : d;
                            case "boolean":
            ...
            return Object.defineProperty(t, "$meta", {
                value: e
            }), t
        },
        L = s => s,
        mt = ":host{user-select:none;-webkit-user-select:none;-webkit-tap-highlight-color:transparent;outline:none}*{outline:none}",
        h = s => {
            let t = {
                observedAttributes: [],
                upperPropKeys: {},
            ...
            for (let a in s.events) {
                let i = `on${a}`;
                t.observedAttributes.push(i), !(i in HTMLElement.prototype) && t.events.push(i)
            }
            let e = new Map;
            class r extends HTMLElement {
                ...
                constructor() {
                    super();
                    let i = this.attachShadow({
                        mode: "open"
                    });
                    i.innerHTML = s.template ?? "", ut(i, [mt, ...s.style ? Array.isArray(s.style) ? s.style : [s.style] : []]);
                    let l = {
                            ...s.props
                        },
                        n, d = {};
                    for (let o in l) {
                        let f = this[o];
                        f !== void 0 && (d[o] = f), Object.defineProperty(this, o, {
                            configurable: !0,
                            get: () => {
                                let x = n?.[o];
                                return !x || typeof x == "function" || !x.get ? l[o] : x.get?.(l[o])
                            },
                            set: x => {
                                let m = t.metaProps[o],
                                ...
                                if (m.sync) {
                                    let v = o.toLowerCase(),
                                        ...
                                        w = String(p);
                                    if (p === m.def && b !== null) return this.removeAttribute(v);
                    ...
                    for (let o of t.events) {
                        let f = o;
                        typeof this[f] == "function" && (c[o] = this[f]), Object.defineProperty(this, o, {
                            configurable: !0,
                            get: () => c[o] ?? null,
                            set: x => c[o] = typeof x == "function" ? x : void 0
                        }), this.addEventListener(o.slice(2), x => c[o] && c[o].bind(this)(x))
                    }
                    n = s.setup?.call(this, i);
                    for (let o in n?.expose ?? {}) Object.defineProperty(this, o, {
                        get: () => n?.expose?.[o]
                    });
                    for (let o in d) this[o] = d[o];
                    this.connectedCallback = this.disconnectedCallback = this.adoptedCallback = this.attributeChangedCallback = void 0, e.set(this, n)
                }
                connectedCallback() {
                ...
                attributeChangedCallback(i, l, n) {
                    if (t.events.includes(i)) return this[i] = n ? new Function("event", n) : null;
    ...
    te.define(gt);
    var bt = "s-appbar",
        // 修改后的样式 - 完全移除高度变化的响应式逻辑
        yt = ":host{display:flex;align-items:center;position:relative;padding:0 8px;margin:0 auto;box-sizing:border-box;background:var(--s-color-surface-container, #ECEEF0)}::slotted([slot=navigation]){margin-left:4px;flex-shrink:0}::slotted([slot=logo]){margin-left:12px;height:32px;color:var(--s-color-primary, #006782);fill:currentColor;flex-shrink:0}::slotted([slot=headline]){font-size:1.5rem;font-weight:700;overflow:hidden;text-transform:capitalize;text-overflow:ellipsis;white-space:nowrap;margin-left:12px;color:var(--s-color-primary, #006782)}.view{flex-grow:1;min-width:0;height:100%;display:flex;align-items:center;height:64px;max-height:100%;justify-content:flex-end}::slotted([slot=action]){margin:0 4px;flex-shrink:0}::slotted(s-search[slot=search]){flex-shrink:0;margin:0 4px 0 8px}",
        wt = '<slot name="start"></slot><slot name="navigation"></slot><slot name="logo"></slot><slot name="headline"></slot><div class="view" part="view"><slot></slot><slot name="search"></slot></div><slot name="action"></slot><slot name="end"></slot>',
        oe = class extends h({
            style: yt,
            template: wt,
            // 完全移除响应式监听逻辑
        ...
        re = class extends h({
            ...
            setup(t) {
                ...
                return {
                    src: r => {
                        e.src = r, e.onload = () => {
                            this.dispatchEvent(new Event("load")), t.insertBefore(e, t.children[0])
                        }, e.onerror = () => {
                            this.dispatchEvent(new ErrorEvent("error")), e.isConnected && t.removeChild(e)
                        }
                    }
                }
            }
    ...
    re.define(kt);
    var St = "s-badge",
        $t = ":host{display:inline-flex;justify-content:center;align-items:center;width:8px;height:8px;border-radius:8px;font-size:.625rem;vertical-align:middle;box-sizing:border-box;background:var(--s-color-error, #BA1A1A);color:var(--s-color-on-error, #ffffff)}:host(:not(:empty)) .text{height:16px;padding:0 5px;display:flex;position:relative;justify-content:center;align-items:center;background:inherit;color:inherit;box-shadow:inherit;border-radius:8px}",
    ...
    var Tt = "s-bottom-sheet",
        ...
        Mt = ':host{display:inline-block;vertical-align:middle}dialog{top:0;left:0;width:100%;height:100%;background:none;border:none;padding:0;max-width:none;max-height:none;outline:none;justify-content:center;align-items:flex-end;color:inherit;overflow:hidden}dialog::backdrop{background:none}dialog[open]{display:flex}.scrim{position:absolute;inset:0;width:100%;height:100%;opacity:0;backdrop-filter:saturate(180%) blur(2px)}.scrim:before{content:"";display:block;width:100%;height:100%;opacity:.75;background:var(--s-color-scrim, #000000)}dialog.show .scrim{opacity:1}.container{outline:none;position:relative;border-radius:24px 24px 0 0;width:100%;max-height:calc(100% - 56px);display:flex;flex-direction:column;padding-bottom:env(safe-area-inset-bottom);max-width:425px;box-shadow:var(--s-elevation-level1, 0 3px 1px -2px rgba(0, 0, 0, .2), 0 2px 2px 0 rgba(0, 0, 0, .14), 0 1px 5px 0 rgba(0, 0, 0, .12));background:var(--s-color-surface-container-low, #F2F4F5)}.indicator{width:100%;display:flex;justify-content:center;align-items:center;height:18px;cursor:pointer;flex-shrink:0}.indicator:before{content:"";width:40px;height:4px;border-radius:2px;background:var(--s-color-outline, #70787D);opacity:.4}::slotted([slot=text]){padding:24px;line-height:22px}::slotted(:not([slot])){overscroll-behavior:none}@media (max-width: 768px){.container{max-width:768px}}',
        At = '<slot name="trigger"></slot><dialog part="popup"><div class="scrim" part="scrim"></div><div class="container" part="container"><div class="indicator" part="indicator"></div><slot name="text"></slot><slot id="view"></slot></div></dialog>',
        Pt = s => {
            let t = document.body,
            ...
            return a.slot = "text", typeof s == "function" || s instanceof HTMLElement ? s instanceof HTMLElement ? r.appendChild(s) : s(r) : typeof s == "string" ? (a.textContent = s, r.appendChild(a)) : (s.root && (t = s.root), s.disabledGesture && (r.disabledGesture = s.disabledGesture), typeof s.view == "string" && (a.textContent = s.view, r.appendChild(a)), s.view instanceof HTMLElement && r.appendChild(s.view), typeof s.view == "function" && s.view(r)), r.addEventListener("closed", () => t.removeChild(r)), r.showed = !0, t.appendChild(r), r
        },
        V = class extends h({
            style: Mt,
            template: At,
            ...
            setup(t) {
                let e = t.querySelector("dialog"),
                    ...
                    n = null,
                    d = () => {
                        let m = l.getPropertyValue("--s-motion-easing-standard") || "cubic-bezier(0.2, 0, 0, 1.0)",
                ...
                t.querySelector("#view").onslotchange = m => {
                    ...
                    this.showed || !this.dispatchEvent(new CustomEvent("show", {
                        cancelable: !0,
                        detail: {
                            source: "TRIGGER"
                        }
                ...
                let c = m => {
                    !this.showed || !this.dispatchEvent(new CustomEvent("close", {
                        cancelable: !0,
                        detail: {
                            source: m
                        }
                ...
                r.addEventListener("touchmove", m => {
                    ...
                    let y = u.pageY - o.y,
                        v = u.pageX - o.x;
                    if (o.top = Math.min(o.h, Math.max(0, y)), p !== i && n && n.scrollTop > 0 || Math.abs(y) < Math.abs(v)) return o.disabled = !0;
                    ...
                    }, d()), r.style.removeProperty("transform");
                    o = null
                };
                let f = () => {
                    ...
                    x = () => {
                        ...
                        a.animate({
                            ...
                            transform: [p === "" ? "translateY(0)" : p, "translateY(100%)"],
                            opacity: [1, 0]
                        }, m).finished.then(() => {
                            e.close(), p && r.style.removeProperty("transform"), this.dispatchEvent(new Event("closed"))
                        })
                    };
                return {
        ...
        z = class extends h({
            ...
            setup(t) {
                let e = t.querySelector(".container"),
                    ...
                    i = () => {
                        let m = a.getPropertyValue("--s-motion-easing-standard") || "cubic-bezier(0.2, 0, 0, 1.0)",
                    ...
                    c = m => {
                        ...
                        if (!this.centered) {
                            let {
                                left: F,
                                top: Oe
                            } = this.getBoundingClientRect(), ee = m.clientX - F, rt = m.clientY - Oe, st = u / 2, it = p / 2, ct = (Math.abs(st - rt) + st) * 2, dt = (Math.abs(it - ee) + it) * 2;
                            y = Math.sqrt(ct ** 2 + dt ** 2), v.x = `${ee}px`, v.y = `${rt}px`
                        }
                        let b = r,
                            w = () => {};
                        d.pressed ? (b = r.cloneNode(), e.appendChild(b), w = () => b.remove()) : (d.pressed = !0, w = () => d.pressed = !1);
                    ...
                    o = async m => {
                        ...
                        if (m.pointerType === "mouse") {
                            document.addEventListener("pointerup", c(m), {
                                once: !0
                            });
                            return
                        }
                        let u;
                        p.timer = setTimeout(() => {
                            u = c(m), document.removeEventListener("touchmove", y), p.upper && u()
                        }, 50), document.addEventListener("touchend", () => {
                        ...
                        m.addEventListener("mouseenter", l), m.addEventListener("mouseleave", n), m.addEventListener("wheel", n, {
                            passive: !0
                        }), m.addEventListener("pointerdown", o)
                    }, x = () => {
                        d.parentNode && (d.parentNode.removeEventListener("mouseenter", l), d.parentNode.removeEventListener("mouseleave", n), d.parentNode.removeEventListener("wheel", n), d.parentNode.removeEventListener("pointerdown", o), d.parentNode = null)
                    };
                return f(this), {
                    onMounted: () => {
                        this.attached && this.parentNode && (d.parentNode = this.parentNode instanceof ShadowRoot ? this.parentNode.host : this.parentNode, f(d.parentNode))
                    },
                    onUnmounted: () => this.attached && x(),
                    attached: m => {
                        if (!this.isConnected) return;
                        if (!m) return x();
                        let p = this.parentNode instanceof ShadowRoot ? this.parentNode.host : this.parentNode;
                        f(p)
                    }
                }
            }
    ...
    z.define(Dt);
    var Ht = "s-button",
            // --- s-button 修改：支持 href / target / name / value / 原生 type（submit/button/reset） ---
        jt = g({
            disabled: !1,
            // 原先的“样式”type（保持向后兼容）
        ...
        ie = class extends h({
            ...
            setup(t) {
                ...
                let injectedHiddenInput = null, injectedHiddenSubmit = null;
                let hostForm = null;
        
                // helper: 判定 html 原生 type（优先 htmlType 属性，其次检查 attribute type 是否为 submit|reset|button）
                function getNativeType(el) {
                    const htmlTypeAttr = (el.getAttribute && el.getAttribute('htmlType')) || "";
                    if (htmlTypeAttr) return String(htmlTypeAttr).toLowerCase();
                    ...
                    // 若未显式声明，则检查 props.htmlType（绑定的 prop）
                    if (t && t.htmlType) {
                        const tt = String(t.htmlType).toLowerCase();
                        if (tt === "submit" || tt === "reset" || tt === "button") return tt;
                    }
                    // 默认不做表单提交行为
                    return "";
                }
        
                // helper: 找到最近的祖先 form（若有）
                function findClosestForm(node) {
                    let n = node;
                    while (n) {
                        if (n.nodeName && n.nodeName.toLowerCase() === "form") return n;
                ...
                return {
                    onMounted: () => {
                        // 使用 this（host element）
                        const host = this;
                        if (!host) return;
        
                        // 把 href 的行为挂上（兼容之前实现）
                        const href = host.getAttribute && host.getAttribute('href');
                        const target = host.getAttribute && host.getAttribute('target');
        
                        // 获取 name/value/htmlType
                        const nameAttr = host.getAttribute && host.getAttribute('name') || "";
                        const valueAttr = host.getAttribute && host.getAttribute('value') || "";
                        const nativeType = getNativeType(host); // submit|reset|button 或 ""
        
                        // 若有 href 则增强为 role=link/可聚焦
                        if (href) {
                            host.setAttribute('role', 'link');
                            if (!host.hasAttribute('tabindex')) host.tabIndex = 0;
                        } else {
                            // 若无 href，但有原生 type（submit/reset），我们需要将按钮作为表单控件
                            if (nativeType) {
                        ...
                        // 处理表单内注入隐藏域与隐藏提交按钮
                        hostForm = findClosestForm(host);
                        if (hostForm) {
                            // 若提供 name/value，则注入隐藏 input（确保在表单提交时提交 name/value）
                            if (nameAttr) {
                                // 创建或复用一个 hidden input（type=hidden）
                                injectedHiddenInput = document.createElement('input');
                                injectedHiddenInput.type = 'hidden';
                                injectedHiddenInput.name = nameAttr;
                                injectedHiddenInput.value = valueAttr || '';
                                // 标记以便调试/清理
                                injectedHiddenInput.setAttribute('data-s-button-hidden', 'true');
                                hostForm.appendChild(injectedHiddenInput);
                            }
                            // 若原生类型为 submit，则注入一个隐藏 submit button，便于触发表单并保留原生行为（支持 form validation）
                            if (nativeType === 'submit') {
                                injectedHiddenSubmit = document.createElement('button');
                                injectedHiddenSubmit.type = 'submit';
                                // 保证不可见与不可交互
                                injectedHiddenSubmit.style.cssText = 'display:none!important;width:0;height:0;border:0;padding:0;margin:0;overflow:hidden;';
                                injectedHiddenSubmit.setAttribute('aria-hidden', 'true');
                                injectedHiddenSubmit.setAttribute('data-s-button-hidden-submit', 'true');
                                hostForm.appendChild(injectedHiddenSubmit);
                            }
                        }
                        ...
                        clickHandler = (e) => {
                            ...
                            // 若是 html 原生 submit/reset/button 的情形
                            if (nativeType && hostForm) {
                                if (nativeType === 'submit') {
                                    // 尝试使用 requestSubmit 支持 form validation；否则点击隐藏 submit button
                                    if (typeof hostForm.requestSubmit === 'function') {
                                        // 若注入了隐藏 submit 元素，将其作为参数以便浏览器能把对应 name/value 一并提交（部分浏览器会把触发的按钮的 name/value 一并提交）
                                        if (injectedHiddenSubmit) {
                                            hostForm.requestSubmit(injectedHiddenSubmit);
                                        } else {
                                            hostForm.requestSubmit();
                                        }
                                    } else if (injectedHiddenSubmit) {
                                        injectedHiddenSubmit.click();
                                    } else {
                                        // 兜底：直接提交（不会触发表单验证）
                                        hostForm.submit();
                                    }
                                    ...
                                    // nativeType === 'button' -> 触发普通点击行为（如果需要，用户可监听 s-button 的 click）
                                    // do nothing special
                                    return;
                                }
                            }
        
                            // 否则为普通按钮行为（可能用户在外部监听 click）
                        };
                    ...
                    onUnmounted: () => {
                        ...
                        // 清理注入到表单的隐藏元素
                        try {
                            if (injectedHiddenInput && injectedHiddenInput.parentNode) injectedHiddenInput.parentNode.removeChild(injectedHiddenInput);
                            if (injectedHiddenSubmit && injectedHiddenSubmit.parentNode) injectedHiddenSubmit.parentNode.removeChild(injectedHiddenSubmit);
                        } catch (err) {
                            // ignore
                        }
                    }
    ...
    var S = class {
        ...
        constructor(t) {
            ...
            e.addEventListener(`${e.tagName.toLocaleLowerCase()}:select`, r => {
                ...
                let a;
                this.flag = !0, r.target.selected = !0, this.list.forEach(i => {
                    i !== r.target && (i.selected && (a = i), i.selected = !1)
                }), this.select = r.target, this.flag = !1, e.dispatchEvent(new Event("change")), this.onUpdate?.(a), this.onSelect?.()
            }), e.addEventListener(`${e.tagName.toLocaleLowerCase()}:update`, r => {
                if (r.stopPropagation(), this.flag || this.list.length === 0 || !(r.target instanceof t.class)) return;
                this.flag = !0;
                let a;
                r.target.selected ? (this.select = r.target, this.list.forEach(i => {
                    i !== r.target && (i.selected && (a = i), i.selected = !1)
                })) : delete this.select, this.flag = !1, this.onUpdate?.(a)
            }), t.slot.addEventListener("slotchange", () => {
                this.flag = !0, delete this.select, this.list = t.slot.assignedElements().filter(r => {
                    if (r instanceof t.class) {
                        if (this.selectValue !== void 0) r.value === this.selectValue ? (this.select = r, r.selected = !0) : r.selected = !1;
                        else {
                ...
                }), this.flag = !1, this.onSlotChange?.(), this.onUpdate?.()
            })
        }
        get value() {
        ...
        set value(t) {
            this.selectValue = t, this.list.length !== 0 && (this.flag = !0, this.list.forEach(e => {
                if (e.value === t) {
                    e.selected = !0, this.select = e;
                    return
                }
                e.selected = !1
            }), this.onUpdate?.(), this.flag = !1)
        }
        get selectedIndex() {
    ...
    var ne = "s-carousel",
        ...
        Xt = ":host{display:flex;align-items:center;position:relative;overflow:hidden;border-radius:8px;cursor:pointer;aspect-ratio:2;-webkit-aspect-ratio:2}.container{display:flex;justify-content:flex-start;height:100%;min-width:100%;transition:transform var(--s-motion-duration-long4, .6s) var(--s-motion-easing-standard, cubic-bezier(.2, 0, 0, 1))}.track{position:absolute;bottom:0;left:0;width:100%;display:flex;gap:8px;align-items:center;justify-content:center;pointer-events:none;padding:12px 0}.track .indicator{width:8px;height:8px;border-radius:4px;background:#fff;opacity:.3;flex-shrink:0;cursor:pointer;pointer-events:auto;box-shadow:var(--s-elevation-level1, 0 3px 1px -2px rgba(0, 0, 0, .2), 0 2px 2px 0 rgba(0, 0, 0, .14), 0 1px 5px 0 rgba(0, 0, 0, .12))}.track .indicator.checked{opacity:1}",
        Gt = '<div class="container" part="container"><slot></slot></div><div class="track"></div>',
        Y = class extends h({
            style: Xt,
            template: Gt,
            props: Ot,
            setup(t) {
                let e = t.querySelector(".container"),
                    ...
                    l = -1;
                i.onUpdate = () => {
                    r.childNodes.forEach(c => c.classList.remove("checked")), e.style.transform = `translateX(${-i.selectedIndex*100}%)`, i.selectedIndex !== -1 && (r.childNodes[i.selectedIndex].classList.add("checked"), n())
                };
                let n = () => {
                        !this.autoplay || i.list.length === 0 || !this.isConnected || (d(), l = setTimeout(() => {
                            let c = i.selectedIndex + 1;
                            c >= i.list.length && (c = 0), i.list[c].selected = !0, this.dispatchEvent(new Event("change"))
                        }, this.duration))
                    },
                    d = () => clearInterval(l);
                return i.onSlotChange = () => {
                    r.innerHTML = "";
                    let c = document.createDocumentFragment();
                    i.list.forEach(o => {
                        let f = document.createElement("div");
                        f.className = "indicator", f.addEventListener("click", () => o.dispatchEvent(new Event(`${ne}:select`, {
                            bubbles: !0
                        }))), c.appendChild(f)
                    }), r.appendChild(c)
                }, e.onpointerdown = c => {
                    ...
                    let o = c.pageX,
                        ...
                        y = w => {
                            let q = w instanceof TouchEvent ? w.touches[0] : w,
                                $ = q.pageX - o,
                                W = q.pageY - f;
                            if (w instanceof TouchEvent && Math.abs($) < Math.abs(W) && !u.next) return v();
                            if (u.left = $, u.now === 0 && (u.now = Date.now()), m && (u.left = Math.min(u.left, x)), p && (u.left = Math.max(u.left, x * -1)), (!m && u.left > 0 || !p && u.left < 0) && (u.left = u.left * .2), u.left < 0 && p || u.left > 0 && m) {
                                let F = Math.abs(u.left) / x * .05;
                                i.select.style.transition = "none", i.select.style.transform = `scale(${.05-F+.95})`, u.next = u.left < 0 ? p : m, u.next.style.transition = "none", u.next.style.transform = `scale(${F+.95})`
                            }
                            e.style.transition = "none", e.style.pointerEvents = "none", e.style.transform = `translateX(calc(${-i.selectedIndex*100}% + ${u.left}px))`, w.cancelable && w.preventDefault()
                        },
                        v = () => {
                            document.removeEventListener(b.up, v), document.removeEventListener(b.move, y), e.style.removeProperty("pointer-events"), e.style.removeProperty("transition"), i.select.style.removeProperty("transition"), i.select.style.removeProperty("transform"), u.next?.style.removeProperty("transition"), u.next?.style.removeProperty("transform");
                            let w = i.selectedIndex;
                            if (!(w === 0 && u.left > 0 || w === i.list.length - 1 && u.left < 0)) {
                                let q = Date.now() - u.now > 300 ? x / 2 : 20;
                                if (Math.abs(u.left) > q) {
                                    u.next?.dispatchEvent(new Event(`${ne}:select`, {
                                        bubbles: !0
                                    }));
                                    return
                                }
                            }
                            e.style.transform = `translateX(${-i.selectedIndex*100}%)`, n()
                        },
                        b = {
                            move: E.pointerCoarse.matches ? "touchmove" : "pointermove",
                            up: E.pointerCoarse.matches ? "touchend" : "pointerup"
                        };
                    document.addEventListener(b.move, y, {
                        passive: !1
        ...
        Jt = ":host{user-drag:none;-webkit-user-drag:none;flex-shrink:0;width:100%;height:100%;border-radius:8px;background:var(--s-color-surface-container-high, #E7E8EA);transform:scale(.95);transition:transform var(--s-motion-duration-long4, .6s) var(--s-motion-easing-standard, cubic-bezier(.2, 0, 0, 1));background-repeat:round}:host([selected=true]){transform:scale(1)}",
        Kt = "<slot></slot>",
        R = class extends h({
            style: Jt,
            template: Kt,
            ...
            setup() {
                return {
                    selected: () => {
                        this.parentNode instanceof Y && this.dispatchEvent(new Event(`${ne}:update`, {
                            bubbles: !0
                        }))
                    }
                }
        ...
        le = class extends h({
            ...
            setup() {
                this.addEventListener("click", () => {
                    this.indeterminate && (this.indeterminate = !1), this.checked = !this.checked, this.dispatchEvent(new Event("change"))
                })
            }
        }) {};
    le.define(eo);
    var so = "s-chip",
        ...
        ce = class extends h({
            ...
            setup(t) {
                let e = t.querySelector("slot[name=action]");
                e.onclick = r => r.stopPropagation(), e.onpointerdown = r => r.stopPropagation(), this.addEventListener("click", () => {
                    this.clickable && (this.checked = !this.checked, this.dispatchEvent(new Event("change")))
                })
            }
        }) {};
    ce.define(so);
                ...
                let e = t.querySelector(".known .track"),
                    ...
                    a = () => {
                        let i = Math.min(this.value, this.max) / this.max * 100,
                            l = A - A * (i / 100),
                            n = i / 100 * 360;
                        e.style.strokeDashoffset = `${i===0?0:Math.min(A+16-l,A)}px`, e.setAttribute("transform", `rotate(${n+20}, ${C/2}, ${C/2})`), r.style.strokeDashoffset = `${l}px`
                    };
                return {
                    max: a,
                    value: a
    ...
    var D = (s, t = "yyyy-MM-dd") => {
        ...
        let e = s.getFullYear(),
            r = s.getMonth() + 1,
            a = s.getDate();
        return t.replace("yyyy", e.toString()).replace("MM", r.toString().padStart(2, "0")).replace("dd", a.toString().padStart(2, "0"))
    };
    var pe = class {
        list;
    ...
    T.list = {
        zh: {
            display: s => `${s.getFullYear()}\u5E74${s.getMonth()+1}\u6708${s.getDate()}\u65E5 \u661F\u671F${T.list.zh.displayWeeks[s.getDay()]}`,
            displayMonth: s => `${s.getFullYear()}\u5E74`,
            displayWeeks: ["\u65E5", "\u4E00", "\u4E8C", "\u4E09", "\u56DB", "\u4E94", "\u516D"]
        },
        en: {
            display: s => `${["Sun","Mon","Tue","Wed","Thu","Fri","Sat"][s.getDay()]}, Jan ${s.getDate()}`,
            displayMonth: s => `${["January","February","March","April","May","June","July","August","September","October","November","December"][s.getMonth()]} ${s.getFullYear()}`,
    ...
    var fo = `<div class="header" part="header"><slot name="headline"></slot><span></span></div><div class="container" part="container"><div class="action"><s-ripple class="button year" slot="trigger"><span></span> <svg viewBox="0 -960 960 960"><path d="M480-360 280-560h400L480-360Z"></path></svg></s-ripple><div class="toggle"><s-ripple class="icon-button prev" part="prev-button"><svg viewBox="0 -960 960 960"><path d="M560-240 320-480l240-240 56 56-184 184 184 184-56 56Z"></path></svg></s-ripple><s-ripple class="icon-button next" part="next-button"><svg viewBox="0 -960 960 960"><path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"></path></svg></s-ripple></div></div><s-scroll-view class="years">${Z.years.join("")}</s-scroll-view><div class="weeks">${Z.weeks.join("")}</div><div class="days">${Z.days.join("")}</div></div>`,
        Xe = class {
            ...
            max;
            constructor(t, e, r) {
                this.date = typeof t == "string" ? new Date(t) : t, this.min = new Date(e), this.max = new Date(r)
            }
        },
        at = (s, t) => {
        ...
        he = class extends h({
            ...
            setup(t) {
                let e = t.querySelector(".container"),
                    ...
                    m = () => {
                        let v = new Date(o.date.getFullYear(), o.date.getMonth(), 1).getDay();
                        c.children[0].setAttribute("style", `margin-left: calc((100% / 7) * ${v})`);
                        let b = new Date(o.date.getFullYear(), o.date.getMonth() + 1, 0).getDate();
                        o.dayOverflow?.classList.remove("overflow"), o.dayOverflow = c.children[b - 1], o.dayOverflow.classList.add("overflow"), o.yearSelect?.classList.remove("checked"), o.yearSelect = n.children[o.date.getFullYear() - o.min.getFullYear()], o.yearSelect.classList.add("checked"), o.daySelect?.classList.remove("checked"), o.daySelect = c.children[o.date.getDate() - 1], o.daySelect.classList.add("checked"), e.style.removeProperty("height")
                    },
                    p = () => {
                        let v = o.max.getFullYear() - o.min.getFullYear();
                        n.innerHTML = "", n.style.counterReset = `year-counter ${o.min.getFullYear()-1}`;
                    ...
                    u = (v, b, w) => {
                        this.value = D(new Date(v, b, w)), this.dispatchEvent(new Event("change"))
                    };
                a.onclick = () => {
                    let v = e.offsetHeight;
                    if (e.classList.toggle("show-years"), e.classList.contains("show-years")) {
                        e.style.height = `${v}px`, o.yearSelect && n.scrollTo({
                            top: o.yearSelect.offsetTop - n.offsetHeight / 2 + o.yearSelect.offsetHeight / 2
                        });
                        return
                    }
                }, i.onclick = () => {
                    ...
                    let b = Array.from(n.children).indexOf(v.target) + o.min.getFullYear();
                ...
                return m(), y(), {
                    ...
                    min: v => {
                        let b = new Date(v);
                        if (isNaN(b.getTime()) || b.getTime() > o.date.getTime()) throw Error("invalid min date");
                        o.min = b, p()
                    },
                    max: v => {
                        let b = new Date(v);
                        if (isNaN(b.getTime()) || b.getTime() < o.date.getTime()) throw Error("invalid max date");
                        o.max = b, p()
                    },
                    value: {
                        get: () => D(o.date),
                        set: v => {
                            let b = new Date(v);
                            if (isNaN(b.getTime()) || b.getTime() < o.min.getTime() || b.getTime() > o.max.getTime()) throw Error("invalid date");
                            o.date = b, f(), m()
                        }
                    },
                    locale: y
    ...
    var bo = "s-date-picker",
        ...
        yo = ":host{display:inline-block;vertical-align:middle;font-size:.875rem;--date-picker-border-radius: 4px;--date-picker-border-color: var(--s-color-outline, #70787D);--date-picker-border-width: 1px;--date-picker-padding: 16px;--date-picker-height: 48px}s-dialog{display:block}.field{--field-border-radius: var(--date-picker-border-radius);--field-border-color: var(--date-picker-border-color);--field-border-width: var(--date-picker-border-width);--field-padding: var(--date-picker-padding);height:var(--date-picker-height);position:relative;cursor:pointer}.view{width:100%;padding-top:0;padding-bottom:0;padding:0 var(--date-picker-padding)}svg{width:24px;height:24px;padding:2px;box-sizing:border-box;flex-shrink:0;margin-left:min(0px,calc((var(--date-picker-padding) * -1) + 12px));margin-right:max(0px,calc(var(--date-picker-padding) - 4px));fill:var(--s-color-on-surface-variant, #40484C)}.ripple{border-radius:var(--date-picker-border-radius)}.date{border:none;width:360px;border-radius:0}.positive,.negative{border-radius:20px}",
        ...
        ue = class extends h({
            ...
            setup(t) {
                ...
                return e.addEventListener("show", () => {
                    l.fixed = !0, l.focused = !0, c.date || (d.textContent = this.label, d.style.opacity = "0")
                }), e.onclose = () => {
                    l.focused = !1, c.date || (l.fixed = !1)
                }, i.onclick = () => {
                    this.value = r.value, d.style.removeProperty("opacity"), this.dispatchEvent(new Event("change"))
                }, {
                    value: {
                        get: () => c.date,
                        set: o => {
                            if (c.date = o, o === "") {
                                r.value = D(new Date), l.fixed = !1, d.textContent = "";
                                return
                            }
                            l.fixed = !0, d.textContent = D(o, this.format), r.value = o
                        }
                    },
                    locale: {
                        get: () => r.locale,
    ...
    var qo = "s-dialog",
        ...
        Lo = s => {
            ...
            if (r && r.tagName === "S-PAGE" && (t = r), typeof s == "string") {
                ...
                if (s.root && (t = s.root), s.disabledGesture && (e.disabledGesture = s.disabledGesture), s.headline) {
                ...
                s.view && (typeof s.view == "string" ? (a.textContent = s.view, e.appendChild(a)) : s.view instanceof HTMLElement ? e.appendChild(s.view) : typeof s.view == "function" && s.view(e));
                let a = s.actions ?? [];
                for (let i of Array.isArray(a) ? a : [a]) {
                    let l = document.createElement("s-button");
                    l.slot = "action", l.type = "text", l.textContent = i.text, i.click && (l.onclick = i.click), e.appendChild(l)
                }
            }
            return e.addEventListener("closed", () => t.removeChild(e)), e.showed = !0, t.appendChild(e), e
        },
        _ = class extends h({
            style: zo,
            template: To,
            ...
            setup(t) {
                let e = t.querySelector("dialog"),
                    ...
                    l = () => {
                        let o = i.getPropertyValue("--s-motion-easing-standard") || "cubic-bezier(0.2, 0, 0, 1.0)",
                ...
                t.querySelector("slot[name=trigger]").onclick = () => {
                    if (this.showed || !this.dispatchEvent(new CustomEvent("show", {
                            cancelable: !0,
                            detail: {
                                source: "TRIGGER"
                            }
                ...
                t.querySelector(".scrim").onclick = () => n("SCRIM"), t.querySelector("slot[name=action]").onclick = () => n("ACTION");
                let d = () => {
                        if (!this.isConnected || e.open) return;
                        let o = l();
                        e.showModal(), e.classList.add("show"), r.animate({
                            opacity: [0, 1]
                        }, o), a.animate({
                            transform: ["scale(.9)", "scale(1)"],
                            opacity: [0, 1]
                        }, o).addEventListener("finish", () => this.dispatchEvent(new Event("showed")))
                    },
                    c = () => {
                        if (!this.isConnected || !e.open) return;
                        let o = l();
                        r.animate({
                            ...
                            e.close(), e.classList.remove("show"), this.dispatchEvent(new Event("closed"))
                        })
                    };
                return {
    ...
    // ================== 新增的快速调用方法 ==================
    _.alert = function(content, title, onConfirm, options = {}) {
        const config = {
            text: content,
    ...
    _.confirm = function(content, title, onConfirm, onCancel, options = {}) {
        const config = {
            text: content,
            ...(title && { headline: title }),
            actions: [
    ...
    _.prompt = function(content, title, onConfirm, onCancel, options = {}) {
        // 创建s-text-field组件
        const textField = document.createElement('s-text-field');
        textField.type = options.type || '';
        textField.value = options.defaultValue || '';
        textField.placeholder = options.placeholder || '';
        textField.label = options.label || '';
        textField.countered = !!options.maxlength;
        ...
        if (options.maxlength) {
            textField.maxLength = options.maxlength;
        }
        ...
        const config = {
            ...
            actions: [
                ...
                {
                    text: options.confirmText || '确定',
                    click: () => onConfirm && onConfirm(textField.value)
                }
            ],
            ...options
        };
        
        const dialog = Lo(config);
        
        // 自动聚焦输入框
        setTimeout(() => {
            const input = textField.shadowRoot.querySelector('input, textarea');
            input && input.focus();
        }, 100);
    ...
    _.define(qo);
    var Fo = "s-divider",
        Mo = ':host{display:flex;align-items:center;margin:0 16px;gap:8px;font-size:.75rem;color:var(--s-color-outline, #70787D)}:host:before,:host:after{content:"";flex-grow:1;border-top:solid 1px var(--s-color-outline-variant, #C0C8CC)}:host(:empty){gap:0}',
        Ao = "<slot></slot>",
        ge = class extends h({
            style: Mo,
            template: Ao
    ...
    var Po = "s-drawer",
        ...
        Zo = '<slot class="view" part="view"></slot><div class="scrim" part="scrim show"></div><slot name="start" class="start show" part="start"></slot><slot name="end" class="end show" part="end"></slot>',
        fe = class extends h({
            style: Do,
            template: Zo,
            setup(t) {
                let e = t.querySelector(".scrim"),
                    ...
                    a = getComputedStyle(this),
                    i = () => {
                        let x = a.getPropertyValue("--s-motion-easing-standard") || "cubic-bezier(0.2, 0, 0, 1.0)",
                    ...
                    c = (x, m) => {
                        ...
                        let b = this.offsetWidth <= 1024 ? {
                            transform: [`translateX(${p.offsetWidth*y}px)`, "translateX(0)"]
                        } : {
                            width: ["0", p.offsetWidth + "px"]
                        };
                        this.offsetWidth <= 1024 && e.animate({
                            opacity: [0, 1]
                        }, v), p.animate(b, v)
                    },
                    o = (x, m) => {
                        ...
                        let y = d(x),
                            ...
                            b = {
                                ...this.offsetWidth <= 1024 ? {
                                    transform: ["translateX(0)", `translateX(${p.offsetWidth*y}px)`]
                                } : {
                                    width: [p.offsetWidth + "px", "0px"]
                                }
                            };
                        p.style.display = "block", p.animate(b, v).finished.then(() => p.style.removeProperty("display")), this.offsetWidth <= 1024 && e.animate({
                            opacity: [1, 0]
                        }, v), p.classList.remove(u), e.classList.remove(u)
                    },
                    f = (x, m) => {
                        let p = l(x),
                            u = n(m);
                ...
                return e.addEventListener("click", () => {
                    o("start", !0), o("end", !0)
                }), P.CSSContainer || new ResizeObserver(() => {
                    e.classList.toggle("s-laptop", this.offsetWidth <= 1024), r.start.classList.toggle("s-laptop", this.offsetWidth <= 1024), r.end.classList.toggle("s-laptop", this.offsetWidth <= 1024)
                }).observe(this), {
                    expose: {
                        show: c,
                        close: o,
    ...
    fe.define(Po);
    var Bo = "s-empty",
        No = ":host{display:flex;justify-content:center;flex-direction:column;align-items:center;padding:48px 16px;gap:12px;font-size:.75rem;border-radius:4px;box-sizing:border-box;color:var(--s-color-outline, #70787D)}.shadow{fill:var(--s-color-surface-container-high, #E7E8EA)}.box{fill:var(--s-color-surface-container-highest, #E1E3E4)}.border{stroke:var(--s-color-outline, #70787D)}::slotted(:is(svg,s-icon)){color:currentColor;fill:currentColor;width:40px}",
        Ho = '<slot name="icon"><svg width="64" height="41" viewBox="0 0 64 41"><g transform="translate(0 1)" fill="none" fill-rule="evenodd"><ellipse cx="32" cy="33" rx="32" ry="7" class="shadow"></ellipse><g fill-rule="nonzero" class="border"><path d="M55 12.76L44.854 1.258C44.367.474 43.656 0 42.907 0H21.093c-.749 0-1.46.474-1.947 1.257L9 12.761V22h46v-9.24z"></path><path class="box" d="M41.613 15.931c0-1.605.994-2.93 2.227-2.931H55v18.137C55 33.26 53.68 35 52.05 35h-40.1C10.32 35 9 33.259 9 31.137V13h11.16c1.233 0 2.227 1.323 2.227 2.928v.022c0 1.605 1.005 2.901 2.237 2.901h14.752c1.232 0 2.237-1.308 2.237-2.913v-.007z"></path></g></g></svg></slot><slot></slot>',
        xe = class extends h({
            style: No,
            template: Ho
        }) {};
    ...
    var O = {
        ...
        Uo = ":host{display:inline-flex;vertical-align:middle;justify-content:center;align-items:center;width:24px;aspect-ratio:1;-webkit-aspect-ratio:1;fill:currentColor;box-sizing:border-box;color:var(--s-color-on-surface-variant, #40484C)}svg,img{width:100%;height:100%}::slotted(*){width:100%;height:100%}",
        Qo = "<slot></slot>",
        ye = class extends h({
            style: Uo,
            template: Qo,
            ...
            setup(t) {
                let e = t.querySelector("slot"),
                    ...
                    a = (i = O.none, l = "") => `<svg viewBox="0 -960 960 960"><path d="${i}" transform="${l}"></path></svg>`;
                return {
                    name: i => {
                        let l = O[i];
                        if (typeof l == "string") return e.innerHTML = a(l);
                        let n = l.name;
                        typeof O[n] == "string" && (e.innerHTML = a(O[n], `rotate(${l.angle} 480 -480)`))
                    },
                    src: async () => {
                        try {
                            ...
                            if (i.pathname.endsWith(".svg")) {
                                ...
                                e.innerHTML = "", e.appendChild(d), this.dispatchEvent(new Event("load"))
                            } else r.src = i.href, r.onload = () => {
                                e.innerHTML = "", e.appendChild(r), this.dispatchEvent(new Event("load"))
                            }, r.onerror = () => this.dispatchEvent(new ErrorEvent("error"))
                        } catch {
        ...
        we = class extends h({
            ...
            setup(t) {
                let e = t.querySelector(".known>.track"),
                    ...
                    a = () => {
                        let i = Math.min(this.value, this.max) / this.max * 100;
                        e.style.transform = `translateX(calc(${i}% + ${i===0?0:4}px))`, r.style.transform = `translateX(${i-100}%)`
                    };
                return {
                    max: a,
                    value: a
    ...
    we.define(Jo);
    var or = "s-menu",
        rr = ":host{display:flex;flex-direction:column;font-size:.875rem;padding:4px 0;background:var(--s-color-surface-container-low, #F2F4F5)}:host(:nth-of-type(n+2)){border-top:solid 1px var(--s-color-surface-variant, #DCE4E8)}::slotted([slot=label]){display:flex;align-items:center;height:44px;margin:-4px 20px;font-size:.75rem;color:var(--s-color-on-surface-variant, #40484C);white-space:nowrap;max-width:100%;overflow:hidden}",
        ...
        ar = `:host{display:flex;flex-direction:column;margin:4px 8px 4px 0;color:var(--s-color-on-surface, #191C1E)}
        .container{display:flex;align-items:center;height:40px;border-radius:0 24px 24px 0;padding:0 20px;flex-shrink:0}
        :host([checked=true]) .container{background:var(--s-color-secondary-container, #CFE6F1);color:var(--s-color-on-secondary-container, #354A53)}
        ...
        :host([checked=true]) ::slotted(:is(svg,s-icon)){color:currentColor}
        ...
        nr = `<s-ripple class="container" part="container">
        ...
        <s-fold class="fold" part="fold" folded="${nt.folded}">
                ...
                if (link) {
                    link.onclick = (event) => {
                        if (this.href) {
                            ...
                            // 关闭菜单
                            this.dispatchEvent(new Event(`${Ke}:click`, {
                                bubbles: !0
                            }));
                        }
                    };
    ...
    var Ue = "s-navigation",
        ...
        ur = ":host{display:flex;align-items:center;justify-content:center;flex-direction:column;cursor:pointer;position:relative;font-size:.75rem;font-weight:500;box-sizing:border-box;width:100%;max-width:80px;text-transform:capitalize;transition:color var(--s-motion-duration-short4, .4s) var(--s-motion-easing-emphasized, cubic-bezier(.2, 0, 0, 1));color:var(--s-color-on-surface, #191C1E)}:host([selected=true]){color:var(--s-color-primary, #006782)}.icon{position:relative;display:flex;justify-content:center;align-items:center;height:28px;width:48px;border-radius:14px;transition:background-color var(--s-motion-duration-short4, .4s) var(--s-motion-easing-emphasized, cubic-bezier(.2, 0, 0, 1))}:host([selected=true]) .icon{background:var(--s-color-secondary-container, #CFE6F1)}::slotted(*){flex-shrink:0}::slotted(svg){color:var(--s-color-on-surface-variant, #40484C);fill:currentColor;width:24px;height:24px}:host([selected=true]) ::slotted(:is(svg,s-icon)){color:currentColor}::slotted([slot=badge]){position:absolute;right:4px;top:0}::slotted([slot=text]){margin-top:4px}",
        mr = '<s-ripple attached="true" class="icon" part="icon"><slot name="icon"></slot><slot name="badge"></slot></s-ripple><slot name="text"></slot>',
        X = class extends h({
            style: ur,
            template: mr,
            props: hr,
            setup() {
                return this.addEventListener("click", () => {
                    this.selected || this.parentNode instanceof B && this.dispatchEvent(new Event(`${Ue}:select`, {
                        bubbles: !0
                    }))
                }), {
                    selected: () => {
                        this.parentNode instanceof B && this.dispatchEvent(new Event(`${Ue}:update`, {
                            bubbles: !0
                        }))
                    }
                }
    ...
    var br = "s-fold",
        ...
        wr = ":host{display:block}.container{display:grid;grid-template-rows:1fr;overflow:hidden;transition:grid-template-rows var(--s-motion-duration-short4, .2s) var(--s-motion-easing-emphasized, cubic-bezier(.2, 0, 0, 1))}:host([folded=true]) .container{grid-template-rows:0fr}.view{display:block;min-height:0;overflow:hidden}",
        kr = '<slot name="trigger"></slot><div class="container" part="container"><slot class="view" part="view"></slot></div>',
        qe = class extends h({
            style: wr,
            template: kr,
            props: yr,
            setup(t) {
                t.querySelector("slot[name=trigger]").onclick = () => this.folded = !this.folded
            }
        }) {};
    qe.define(br);
    var Er = "s-page",
    ...
    var Se = class extends h({
        ...
        setup() {
            let t = getComputedStyle(this),
                ...
                r = () => {
                    let i = t.getPropertyValue("--s-motion-easing-standard-accelerate") || "cubic-bezier(0.3, 0, 1, 1)",
            ...
            return {
                expose: {
                    toggle: (i, l) => new Promise(n => {
                        if (this.theme === i) return;
                        let d = e.matches,
                            c = y => y === "auto" ? d ? "dark" : "light" : y,
                            o = c(this.theme),
                            f = c(i);
                        if (o === f || !document.startViewTransition) return this.theme = i, n();
                        let x = innerWidth,
                            m = innerHeight,
                            p = {
                                clipPath: [`circle(0px at 50% ${m/2}px)`, `circle(${Math.sqrt(x**2+m**2)/2}px at 50% ${m/2}px)`]
                            };
                        if (l && l.isConnected) {
                            let {
                                left: y,
                                top: v
                            } = l.getBoundingClientRect(), b = y + l.offsetWidth / 2, w = v + l.offsetHeight / 2, q = Math.max(x - b, b), $ = Math.max(m - w, w), W = Math.sqrt(q ** 2 + $ ** 2);
                            p.clipPath[0] = `circle(0px at ${b}px ${w}px)`, p.clipPath[1] = `circle(${W}px at ${b}px ${w}px)`
                        }
                ...
                theme: i => {
                    ...
                    let l = () => {
                        e.matches ? this.setAttribute("dark", "") : this.removeAttribute("dark"), this.dispatchEvent(new Event("change"))
                    };
                    e.onchange = l, l()
                }
            }
    ...
    var $r = "s-pagination",
        ...
        Tr = ":host{display:inline-flex;justify-content:center;align-items:center;font-size:.875rem;border-radius:18px;gap:4px;color:var(--s-color-on-surface, #191C1E)}:host([type=outlined]) :is(.icon-button,.button){border-width:1px;border-color:var(--s-color-outline-variant, #C0C8CC);border-style:solid}.container{display:flex;flex-wrap:wrap;gap:inherit;height:100%;border-radius:inherit;justify-content:space-evenly}.icon-button,.button{cursor:pointer;display:flex;justify-content:center;align-items:center;box-sizing:border-box;height:36px}.icon-button{border-radius:inherit;aspect-ratio:1;-webkit-aspect-ratio:1}.button{aspect-ratio:1;-webkit-aspect-ratio:1;padding:0 8px;border-radius:inherit;box-sizing:border-box}.checked{background:var(--s-color-secondary-container, #CFE6F1);color:var(--s-color-on-secondary-container, #354A53);border-color:var(--s-color-secondary, #4C616B)!important}.disabled{pointer-events:none;opacity:.38}.text{pointer-events:none;border:none!important}svg{width:24px;height:24px;padding:1px;box-sizing:border-box;fill:var(--s-color-on-surface-variant, #40484C)}",
        Lr = '<s-ripple class="prev icon-button disabled" part="prev"><svg viewBox="0 -960 960 960"><path d="M560-240 320-480l240-240 56 56-184 184 184 184-56 56Z"></path></svg></s-ripple><div class="container"><s-ripple class="button checked">1</s-ripple></div><s-ripple class="next icon-button disabled" part="next"><svg viewBox="0 -960 960 960"><path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"></path></svg></s-ripple>',
        $e = class extends h({
            style: Tr,
            template: Lr,
            props: zr,
            setup(t) {
                let e = t.querySelector(".prev"),
                    ...
                    l = () => {
                        ...
                        if (a.childNodes.forEach(o => {
                                c++;
                                let f = o;
                                f.textContent = c.toString(), f.classList.toggle("checked", this.value === c), f.classList.remove("text")
                            }), e.classList.toggle("disabled", this.value === 1), r.classList.toggle("disabled", this.value === d), d > 7) {
                            if (this.value >= 5) {
                            ...
                            if (this.value <= d - 4) {
                                a.childNodes.item(a.childNodes.length - 1).textContent = d.toString();
                ...
                return a.onclick = d => {
                    ...
                    let d = Math.min(this.value + 1, Math.ceil(this.total / this.count));
                    d !== this.value && (this.value = d, i())
                }, {
                    total: n,
                    value: l
    ...
    var Je = "s-picker",
        ...
        Mr = ":host{display:inline-block;vertical-align:middle;font-size:.875rem;--picker-border-radius: 4px;--picker-border-color: var(--s-color-outline, #70787D);--picker-border-width: 1px;--picker-padding: 16px;--picker-height: 48px}:host([disabled=true]){pointer-events:none;opacity:.38}.popup{display:block;cursor:pointer;position:relative}.ripple{border-radius:var(--picker-border-radius)}.field{--field-border-radius: var(--picker-border-radius);--field-border-color: var(--picker-border-color);--field-border-width: var(--picker-border-width);--field-padding: var(--picker-padding);height:var(--picker-height);width:100%;position:relative}.view{width:100%;padding-top:0;padding-bottom:0;padding:0 var(--picker-padding)}svg{width:24px;height:24px;padding:2px;box-sizing:border-box;flex-shrink:0;margin-left:min(0px,calc((var(--picker-padding) * -1) + 4px));margin-right:max(0px,calc(var(--picker-padding) - 12px));fill:var(--s-color-on-surface-variant, #40484C)}.container{max-height:408px;box-sizing:border-box;display:flex;flex-direction:column;font-size:.875rem;padding:4px 0;gap:4px}",
        Ar = '<s-popup class="popup"><slot name="trigger" slot="trigger"><s-field fixed="false" class="field" part="field"><div class="label" slot="label"></div><div class="view"></div><svg viewBox="0 -960 960 960" slot="end"><path d="M480-360 280-560h400L480-360Z"></path></svg><s-ripple slot="custom" class="ripple" attached="true"></s-ripple></s-field></slot><s-scroll-view class="container" part="container"><slot id="slot"></slot></s-scroll-view></s-popup>',
        N = class extends h({
            style: Mr,
            template: Ar,
            props: Fr,
            setup(t) {
                ...
                return e.addEventListener("show", () => {
                    r.focused = !0, r.fixed = !0, d.select || (i.textContent = this.label, i.style.opacity = "0"), n.style.minWidth = `${this.offsetWidth}px`, d.select && n.scrollTo({
                        top: d.select.offsetTop - n.offsetTop - (n.offsetHeight / 2 - d.select.offsetHeight / 2)
                    })
                }), e.onclose = () => {
                    r.focused = !1, !d.select && (r.fixed = !1)
                }, e.addEventListener("closed", () => n.style.removeProperty("min-width")), d.onUpdate = () => {
                    if (!d.select) {
                        r.fixed = !1, i.textContent = "";
                        return
                    }
                    r.fixed = !0, i.style.removeProperty("opacity"), i.textContent = d.select.textContent
                }, d.onSelect = () => e.close(), {
                    expose: {
                        get options() {
                            return d.list
        ...
        G = class extends h({
            ...
            setup() {
                return this.addEventListener("click", () => {
                    this.selected || this.parentNode instanceof N && this.dispatchEvent(new Event(`${Je}:select`, {
                        bubbles: !0
                    }))
                }), {
                    selected: () => {
                        this.parentNode instanceof N && this.dispatchEvent(new Event(`${Je}:update`, {
                            bubbles: !0
                        }))
                    }
                }
    ...
    var Nr = "s-popup",
        ...
        Vr = (s, t, e, r) => {
            ...
            if (i) a.left = s.left - (t - s.width) / 2, a.origin[0] = "center", a.left < 0 ? (a.left = s.left, a.origin[0] = `${s.width/2}px`) : a.left + t > innerWidth && (a.left = s.left + s.width - t, a.origin[0] = `${t-s.width+s.width/2}px`);
            else {
                let d = f => {
                        a.left = s.left - t, a.origin[0] = "right", a.left < 0 && f && f()
                    },
                    c = f => {
                        a.left = s.left + s.width, a.origin[0] = "left", a.left + t > innerWidth && f && f()
                    },
                    o = () => {
        ...
        ze = class extends h({
            ...
            setup(t) {
                let e = t.querySelector("dialog"),
                    ...
                    a = getComputedStyle(this),
                    i = () => {
                        let c = a.getPropertyValue("--s-motion-easing-standard") || "cubic-bezier(0.2, 0, 0, 1.0)",
                    ...
                    l = c => {
                        ...
                        if (e.showModal(), !this.dispatchEvent(new Event("show", {
                                cancelable: !0
                            }))) return e.close();
                        r.style.maxHeight = `${innerHeight}px`, r.style.maxWidth = `${innerWidth}px`;
                        let f = r.offsetWidth,
                            x = r.offsetHeight;
                        ...
                        } else o.top = c.y, o.left = c.x, o.origin = c.origin?.split(" ") ?? ["left", "top"], c.x + f > innerWidth && (o.left = c.x - f, o.origin[0] = "right"), c.y + x > innerHeight && (o.top = c.y - x, o.origin[1] = "bottom");
                        r.style.transformOrigin = o.origin.join(" "), r.style.top = `${o.top}px`, r.style.left = `${o.left}px`;
                        let m = r.animate({
                            transform: ["scale(.9)", "scale(1)"],
                            opacity: [0, 1]
                        }, i());
                        this.setAttribute("showed", ""), m.finished.then(() => this.dispatchEvent(new Event("showed")))
                    },
                    n = () => {
                        if (!this.isConnected || !e.open || r.getAnimations().length > 0 || !this.dispatchEvent(new Event("close", {
                                cancelable: !0
                            }))) return;
                        let c = r.animate({
                            transform: ["scale(1)", "scale(.9)"],
                        ...
                        this.removeAttribute("showed"), c.finished.then(() => {
                            e.close(), this.dispatchEvent(new Event("closed"))
                        })
                    },
                    d = c => e.open ? n() : l(c);
                return t.querySelector("slot[name=trigger]").addEventListener("click", () => l()), t.querySelector(".scrim").addEventListener("pointerdown", n), {
                    expose: {
                        show: l,
                        toggle: d,
                        close: n
    ...
    var Ke = "s-popup-menu",
        ...
        Rr = ":host{display:inline-block;vertical-align:middle;font-size:.875rem}.popup{display:block}.container{box-sizing:border-box;padding:4px 0;max-width:224px;min-height:auto;display:flex;flex-direction:column;gap:4px}::slotted(s-popup-menu[group=start]){border-top:solid 1px var(--s-color-outline-variant, #C0C8CC);margin-top:4px;padding-top:4px}::slotted(s-popup-menu[group=end]){border-bottom:solid 1px var(--s-color-outline-variant, #C0C8CC);margin-bottom:4px;padding-bottom:4px}",
        _r = '<s-popup class="popup"><slot slot="trigger" name="trigger"></slot><s-scroll-view class="container" part="container"><slot></slot></s-scroll-view></s-popup>',
        ...
        Le = class extends h({
            ...
            template: Gr,
            setup() {
                this.addEventListener("click", () => this.dispatchEvent(new Event(`${Ke}:click`, {
                    bubbles: !0
                })))
            }
        }) {};
    ...
    var Ur = "s-radio-button",
        ...
        Fe = class extends h({
            ...
            setup() {
                this.addEventListener("click", () => {
                    this.checked = !0, this.name && document.querySelectorAll(`${this.tagName}[name='${this.name}']`).forEach(t => {
                        t !== this && (t.checked = !1)
    ...
    var es = "s-rate",
        ...
        ts = ":host{display:inline-flex;vertical-align:middle;overflow:hidden;position:relative;font-size:24px;width:5em;height:1em}.track{width:100%;display:flex}.track svg,::slotted([slot=track]){fill:var(--s-color-secondary-container, #CFE6F1);filter:drop-shadow(1em 0 0 var(--s-color-secondary-container, #CFE6F1)) drop-shadow(2em 0 0 var(--s-color-secondary-container, #CFE6F1)) drop-shadow(3em 0 0 var(--s-color-secondary-container, #CFE6F1))}.indicator{position:absolute;left:0;top:0;height:100%;width:50%;overflow:hidden;display:flex}.indicator svg,::slotted([slot=indicator]){fill:var(--s-color-primary, #006782);filter:drop-shadow(1em 0 0 var(--s-color-primary, #006782)) drop-shadow(2em 0 0 var(--s-color-primary, #006782)) drop-shadow(3em 0 0 var(--s-color-primary, #006782)) drop-shadow(4em 0 0 var(--s-color-primary, #006782))}svg,::slotted(*){height:100%;aspect-ratio:1;-webkit-aspect-ratio:1;flex-shrink:0}input{position:absolute;left:0;top:0;height:100%;width:100%;cursor:pointer;opacity:0;margin:0}:host([readonly=true]) input{display:none}",
        ...
        Me = class extends h({
            ...
            setup(t) {
                ...
                return r.onchange = () => this.dispatchEvent(new Event("change")), r.oninput = () => {
                    this.value = Number(r.value), this.dispatchEvent(new Event("input"))
                }, {
                    max: i => {
                        r.max = String(i), a()
                    },
    ...
    var rs = "s-search",
        ...
        Ae = class extends h({
            ...
            setup(t) {
                ...
                return a.onmousedown = l => l.preventDefault(), e.onchange = () => this.dispatchEvent(new Event("change")), r.onclick = () => {
                    e.value = "", i(), this.dispatchEvent(new Event("input")), this.dispatchEvent(new Event("change"))
                }, e.oninput = i, {
                    expose: {
                        get native() {
                            return e
    ...
    var et = "s-segmented-button",
        ...
        H = class extends h({
            ...
            setup(t) {
                let e = t.querySelector("slot"),
                    ...
                    a = getComputedStyle(this),
                    i = () => {
                        let l = a.getPropertyValue("--s-motion-easing-standard") || "cubic-bezier(0.2, 0, 0, 1.0)",
                ...
                return r.onUpdate = l => {
                    ...
                    let n = l.shadowRoot.querySelector(".indicator").getBoundingClientRect(),
                        d = r.select.shadowRoot.querySelector(".indicator"),
                        c = d.getBoundingClientRect(),
                        o = n.left - c.left;
                    d.style.transform = `translateX(${c.left>n.left?o:Math.abs(o)}px)`, d.style.width = `${n.width}px`, l.style.zIndex = "1";
                    let f = d.animate([{
                        transform: "translateX(0)",
                        width: `${c.width}px`
                    }], i());
                    f.onfinish = f.oncancel = f.onremove = () => {
                        d.style.removeProperty("transform"), d.style.removeProperty("width"), l.style.removeProperty("z-index")
                    }
                }, {
                    expose: {
                        get options() {
        ...
        Q = class extends h({
            ...
            setup() {
                return this.addEventListener("click", () => {
                    !(this.parentNode instanceof H) || this.selected || this.selectable && this.dispatchEvent(new Event(`${et}:select`, {
                        bubbles: !0
                    }))
                }), {
                    selected: () => {
                        this.parentNode instanceof H && this.dispatchEvent(new CustomEvent(`${et}:update`, {
                            bubbles: !0,
                            detail: {}
                        }))
                    }
            ...
            setup(t) {
                let e = t.querySelector(".container"),
                    ...
                    d = () => {
                        ...
                        i.style.left = `calc(${o}% - ${o*.16}px)`, r.style.width = `calc(${o}% - ${4+o*.16}px)`, a.style.width = `calc(${100-o}% - ${20-o*.16}px)`, l.textContent = String(c)
                    };
                return n.onchange = () => this.dispatchEvent(new Event("change")), n.oninput = () => {
                    this.value = Number(n.value), this.dispatchEvent(new Event("input"))
                }, n.onmousedown = c => c.button === 0 && E.pointerFine.matches && e.classList.add("active"), n.onmouseup = () => E.pointerFine.matches && e.classList.remove("active"), n.ontouchstart = () => E.pointerCoarse.matches && e.classList.add("active"), n.ontouchend = () => E.pointerCoarse.matches && e.classList.remove("active"), n.ontouchcancel = () => E.pointerCoarse.matches && e.classList.remove("active"), {
                    max: c => {
                        n.max = String(c), d()
                    },
                    min: c => {
    ...
    Ze.setAttribute("style", "position: fixed;right: 0;bottom: 0;width: 100%;height: 100%;pointer-events: none");
    var Be = s => {
        s.appendChild(Ze);
        let t = Ze.getBoundingClientRect();
        return s.removeChild(Ze), {
            left: t.left,
            top: t.top,
            width: t.width,
            height: t.height
        ...
        J = class extends h({
            ...
            setup(t) {
                let e = t.querySelector(".popup"),
                    ...
                    a = getComputedStyle(this),
                    i = () => {
                        let o = a.getPropertyValue("--s-motion-easing-standard") || "cubic-bezier(0.2, 0, 0, 1.0)",
                    ...
                    n = () => this.align === "auto" ? E.pointerCoarse.matches ? "top" : "bottom" : this.align,
                    d = () => {
                        if (!this.isConnected || e.classList.contains("show")) return;
                        if (e.classList.add("show"), e.showPopover) e.showPopover();
                        else {
                            let u = Be(t);
                            e.style.width = `${innerWidth}px`, e.style.height = `${innerHeight}px`, e.style.marginLeft = `${-u.left}px`, e.style.marginTop = `${-u.top}px`, e.style.zIndex = "3"
                        }
                        let o = n();
                        r.style.alignSelf = {
                            top: "flex-start",
                        ...
                        for (let u of f) u.style.transform = `translateY(${m*x}px)`, m += u.firstElementChild.offsetHeight + l.gap;
                        let p = r.animate({
                            opacity: [0, 1],
                        ...
                        this.dispatchEvent(new Event("show")), this.duration > 0 && (l.timer = setTimeout(c, this.duration)), e.dataset.align = o, f.unshift(e), p.finished.then(() => this.dispatchEvent(new Event("showed")))
                    },
                    c = () => {
                        if (!this.isConnected || !e.classList.contains("show")) return;
                        ...
                        for (let u = m + 1; u < f.length; u++) {
                            ...
                            y.style.transform = `translateY(${(v-r.offsetHeight-l.gap)*x}px)`
                        }
                        let p = r.animate({
                            opacity: [1, 0],
                            transform: `translateY(calc(${x*-100}% + 16px))`
                        }, i());
                        this.dispatchEvent(new Event("close")), p.finished.then(() => {
                            e.hidePopover && e.hidePopover(), e.removeAttribute("style"), e.classList.remove("show"), this.dispatchEvent(new Event("closed"))
                        }), f.splice(m, 1)
                    };
                return r.onmouseenter = () => clearTimeout(l.timer), r.onmouseleave = () => e.classList.contains("show") && this.duration > 0 && (l.timer = setTimeout(c, this.duration)), t.querySelector("slot[name=trigger]").onclick = d, t.querySelector("slot[name=action]").onclick = c, {
                    expose: {
                        show: d,
                        close: c
                    }
    ...
    // 添加JavaScript API
    J.builder = Cs;
    J.show = function(config) {
        return J.builder(config);
    };
    J.info = function(text, options) {
        return J.builder({ ...options, text, type: 'info' });
    };
    J.success = function(text, options) {
        return J.builder({ ...options, text, type: 'success' });
    };
    J.warning = function(text, options) {
        return J.builder({ ...options, text, type: 'warning' });
    };
    J.error = function(text, options) {
        return J.builder({ ...options, text, type: 'error' });
    };
    
    // 将Snackbar添加到全局sober对象
    if (globalThis.sober) {
        globalThis.sober.Snackbar = J;
    }
    ...
    var tt = "s-tab",
        ...
        Ls = ':host{display:flex;justify-content:flex-start;position:relative;background:var(--s-color-surface, #F8F9FB);color:var(--s-color-on-surface-variant, #40484C)}:host:before{content:"";position:absolute;width:100%;border-bottom:solid 1px var(--s-color-surface-variant, #DCE4E8);bottom:0;left:0}.container{display:flex;justify-content:flex-start;align-items:center;position:relative;scrollbar-width:none;overflow-x:auto}.container::-webkit-scrollbar{display:none}:host([mode=fixed]) .container{overflow:hidden;width:100%}::slotted(s-tab-item){flex-shrink:0;flex-basis:auto}:host([mode=fixed]) ::slotted(s-tab-item){flex-basis:100%;flex-shrink:1}',
        ...
        I = class extends h({
            ...
            setup(t) {
                let e = t.querySelector("slot"),
                    ...
                    i = getComputedStyle(this),
                    l = () => {
                        let n = i.getPropertyValue("--s-motion-easing-standard") || "cubic-bezier(0.2, 0, 0, 1.0)",
                ...
                return a.onUpdate = n => {
                    if (a.select && r.scrollWidth !== r.offsetWidth) {
                        let m = a.select.offsetLeft - r.offsetLeft - (r.offsetWidth / 2 - a.select.offsetWidth / 2);
                        r.scrollTo({
                            left: m,
                            behavior: "smooth"
                        })
                    ...
                    let d = n.shadowRoot.querySelector(".indicator").getBoundingClientRect(),
                        c = a.select.shadowRoot?.querySelector(".indicator"),
                        o = c.getBoundingClientRect(),
                        f = d.left - o.left;
                    c.style.transform = `translateX(${o.left>d.left?f:Math.abs(f)}px)`, c.style.width = `${d.width}px`;
                    let x = c.animate([{
                        transform: "translateX(0)",
                        width: `${o.width}px`
                    }], l());
                    x.onfinish = x.oncancel = x.onremove = () => {
        ...
        K = class extends h({
            ...
            setup(t) {
                let e = t.querySelector(".container");
                return t.querySelector("[name=icon]").addEventListener("slotchange", r => {
                    let a = r.target.assignedElements().length;
                    e.classList[a > 0 ? "add" : "remove"]("icon")
                }), this.addEventListener("click", () => {
                    !(this.parentNode instanceof I) || this.selected || this.dispatchEvent(new Event(`${tt}:select`, {
                        bubbles: !0
                    }))
                }), {
                    selected: () => {
                        this.parentNode instanceof I && this.dispatchEvent(new Event(`${tt}:update`, {
                            bubbles: !0
                        }))
                    }
                }
    ...
    var Zs = "s-table",
        Bs = ":host{display:inline-block;font-size:.875rem;overflow:auto;border:solid 1px var(--s-color-outline-variant, #C0C8CC);border-radius:4px;white-space:nowrap}slot{display:table;border-collapse:collapse;min-width:100%}@media (pointer: fine){:host::-webkit-scrollbar{width:6px;height:6px;background:transparent}:host::-webkit-scrollbar-thumb{background:var(--s-color-outline-variant, #C0C8CC);border-radius:3px}@supports not selector(::-webkit-scrollbar){:host{scrollbar-color:var(--s-color-outline-variant, #C0C8CC) transparent}}}",
        Ns = "<slot></slot>",
        He = class extends h({
            style: Bs,
            template: Ns
        ...
        Hs = "s-thead",
        js = ":host{display:table-header-group;font-weight:600;position:sticky;top:0;border-bottom:solid 1px var(--s-color-outline-variant, #C0C8CC);background:var(--s-color-surface-container, #ECEEF0);color:var(--s-color-on-surface-variant, #40484C)}",
        Is = "<slot></slot>",
        je = class extends h({
            style: js,
            template: Is
        ...
        Ws = "s-tbody",
        Vs = ":host{display:table-row-group;color:var(--s-color-on-surface, #191C1E)}::slotted(s-tr:not(:first-child)){border-top:solid 1px var(--s-color-outline-variant, #C0C8CC)}",
        Ys = "<slot></slot>",
        Ie = class extends h({
            style: Vs,
            template: Ys
        ...
        Xs = "s-th",
        Gs = ":host{display:table-cell;padding:12px 16px;text-transform:capitalize}",
        Us = "<slot></slot>",
        Ve = class extends h({
            style: Gs,
            template: Us
    ...
    He.define(Zs), je.define(Hs), Ie.define(Ws), We.define(Rs), Ve.define(Xs), Ye.define(Qs);
    var ei = "s-text-field",
        ti = g({
            $label: "",
            $placeholder: "",
        ...
        Re = class extends h({
            ...
            setup(t) {
                let e = t.querySelector(".field"),
                    ...
                    c = () => {
                        this.countered && (i.textContent = `${d().value.length}/${this.maxLength}`)
                    },
                ...
                // --- 新增：确保初始 name 属性应用到原生元素（如果组件上有 name 属性）
                n.input.name = this.name || "";
                n.textarea.name = this.name || "";
    
                n.input.oninput = c, n.input.onfocus = f, n.input.onblur = x, n.input.onchange = o, n.textarea.onfocus = f, n.textarea.onblur = x, n.textarea.onchange = o, n.textarea.oninput = () => {
                    a.textContent = n.textarea.value, c()
                };
                let m = p => {
                    this.value = `${parseInt(this.value||"0")+p}`, this.dispatchEvent(new Event("input")), this.dispatchEvent(new Event("change"))
                };
                return t.querySelector(".up").onclick = () => m(1), t.querySelector(".down").onclick = () => m(-1), t.querySelector(".visibility").onclick = () => {
                    n.input.type = l.classList.contains("show-password") ? "password" : "text", l.classList.toggle("show-password")
                }, {
                    expose: {
                        get native() {
                            return d()
                    ...
                    type: (p, u) => {
                        n.input.type = p === "password" ? l.classList.contains("show-password") ? "text" : "password" : p, p === "multiline" && (n.textarea.value = n.input.value, a.textContent = n.input.value), u === "multiline" && (n.input.value = n.textarea.value)
                    },
                    error: p => {
                    ...
                    value: {
                        get: () => d().value,
                        set: p => {
                            n.input.value = p, n.textarea.value = p, a.textContent = p, c(), this.error || (e.fixed = p !== "")
                        }
                    },
                    placeholder: p => {
                    ...
                    // --- 新增：name 映射（当组件的 name 发生变化时更新内部原生元素）
                    name: p => {
                        n.input.name = p, n.textarea.name = p
                    },
                    countered: c
                }
            }
            ...
            setup(t) {
                let e = t.querySelector("slot[name=trigger]"),
                    ...
                    n = () => {
                        ...
                        if (r.style.display = "block", i = !0, r.showPopover) r.showPopover();
                        else {
                            let y = Be(t);
                            r.style.marginLeft = `${-y.left}px`, r.style.marginTop = `${-y.top}px`, r.style.zIndex = "3"
                        }
                        let o = this.getBoundingClientRect(),
                            ...
                            u = {
                                middle(y) {
                                    ...
                                    let v = () => (p.top = o.top + o.height + f, p.top + m > innerHeight),
                                        b = () => (p.top = o.top - m - f, p.top < 0);
                                    p.left < 0 && (p.left = o.left), p.left + x > innerWidth && (p.left = o.left + o.width - x), y === "top" && b() && v(), y === "bottom" && v() && b()
                                },
                                left() {
                                    return p.left = o.left - x - f, p.top = o.top - (m - o.height) / 2, p.left < 0
                                },
                                right() {
                                    return p.left = o.left + o.width + f, p.top = o.top - (m - o.height) / 2, p.left + x > innerWidth
                                }
                            };
                        switch (this.align) {
                            case "bottom":
                        ...
                        r.style.top = `${p.top}px`, r.style.left = `${p.left}px`, r.animate({
                            opacity: [0, 1]
                        }, l())
                    },
                    d = 0,
                    c = () => {
                        clearTimeout(d), i = !1, r.animate({
                            opacity: [1, 0]
                        }, l()).finished.then(() => {
                            i || (r.hidePopover && r.hidePopover(), r.style.removeProperty("display"))
                        })
                    };
                e.addEventListener("touchstart", () => {
                    E.pointerFine.matches || (clearTimeout(d), d = setTimeout(() => n(), 600))
                }, {
                    passive: !0
                }), e.ontouchend = () => {
                    clearTimeout(d), c()
                }, e.onmouseenter = () => E.pointerFine.matches && n(), e.onmouseleave = () => E.pointerFine.matches && c()
            }
        }) {};
    _e.define(si);
